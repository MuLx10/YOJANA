...
<html>
	...
	<body>
		<h1  style = "font-family:'Georgia', serif; font-size: 50px; word-spacing: 0px; text-align:top; color:#303030;margin-top: -50px;"> YOJANA</h1><br/>
		...
		<br>
		<form  method = "POST">
			<a class = "button" href="Allocate.php?state=0">Allocate</a>
			<a class = "button" href="ViewResource.php?user_type=1&aadhar=<?php echo $aadhar ?>">View Resources</a><br/>
